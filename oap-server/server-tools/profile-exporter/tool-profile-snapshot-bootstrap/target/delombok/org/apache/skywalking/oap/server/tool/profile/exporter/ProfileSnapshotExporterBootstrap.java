...
public class ProfileSnapshotExporterBootstrap {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ProfileSnapshotExporterBootstrap.class);

    public static void export(String[] args) {
        TerminalFriendlyTable bootingParameters = new TerminalFriendlyTable("The key booting parameters of Apache SkyWalking OAP are listed as following.");
        ...
        try {
            ...
            log.info("Queried profiled basic info, segment count: {}, total span count:{}", profiledBaseInfo.getSegments().size(), profiledBaseInfo.getProfiledSegmentSpans().size());
