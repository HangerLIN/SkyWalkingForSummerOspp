...
public class SegmentGeneratorHandler {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(SegmentGeneratorHandler.class);
    ...
    public HttpResponse generateMockSegments(@Default("0") @Param("size") int size, @Default("0") @Param("qps") int qps, @RequestObject SegmentRequest request) {
        if (size > 0 && qps > 0) {
