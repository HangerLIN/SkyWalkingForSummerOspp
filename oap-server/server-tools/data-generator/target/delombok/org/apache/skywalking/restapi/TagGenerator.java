...
public final class TagGenerator implements Generator<Tag> {
    ...
    @lombok.Generated
    public Generator<String> getKey() {
        return this.key;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public Generator<String> getValue() {
        return this.value;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setKey(final Generator<String> key) {
        this.key = key;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setValue(final Generator<String> value) {
        this.value = value;
    }
}
