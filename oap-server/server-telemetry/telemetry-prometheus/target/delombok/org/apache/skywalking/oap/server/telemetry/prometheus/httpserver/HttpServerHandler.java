...
public class HttpServerHandler extends SimpleChannelInboundHandler<HttpObject> {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(HttpServerHandler.class);
    ...
    public void channelRead0(ChannelHandlerContext ctx, HttpObject msg) {
        if (msg instanceof HttpRequest) {
            ...
            FullHttpResponse response = new DefaultFullHttpResponse(req.protocolVersion(), OK, Unpooled.copiedBuffer(buf.getBuilder().toString(), CharsetUtil.UTF_8));
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) {
        ...
        FullHttpResponse response = new DefaultFullHttpResponse(HttpVersion.HTTP_1_1, INTERNAL_SERVER_ERROR, Unpooled.wrappedBuffer(cause.getMessage().getBytes()));
