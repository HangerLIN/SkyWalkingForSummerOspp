...
public class BrowserLogQuery implements GraphQLQueryResolver {
    ...
    public BrowserErrorLogs queryBrowserErrorLogs(BrowserErrorLogQueryCondition condition) throws IOException {
        return getQueryService().queryBrowserErrorLogs(condition.getServiceId(), condition.getServiceVersionId(), condition.getPagePathId(), condition.getCategory(), condition.getQueryDuration(), condition.getPaging());
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public BrowserLogQuery(final ModuleManager moduleManager) {
