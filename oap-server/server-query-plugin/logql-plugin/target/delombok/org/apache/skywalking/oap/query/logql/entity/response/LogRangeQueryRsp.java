...
public class LogRangeQueryRsp extends QueryResponse {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setData(final StreamLog data) {
        this.data = data;
    }
    ...
    public java.lang.String toString() {
        return "LogRangeQueryRsp(data=" + this.getData() + ")";
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof LogRangeQueryRsp)) return false;
        final LogRangeQueryRsp other = (LogRangeQueryRsp) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof LogRangeQueryRsp;
    }
