...
public class DebuggingHTTPHandler {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(DebuggingHTTPHandler.class);
    ...
    public DebuggingHTTPHandler(final ModuleManager manager, final DebuggingQueryConfig config) {
        serverStatusService = manager.find(CoreModule.NAME).provider().getService(ServerStatusService.class);
        this.config = config;
    }
