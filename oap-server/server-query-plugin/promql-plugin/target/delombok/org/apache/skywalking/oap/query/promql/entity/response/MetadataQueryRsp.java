...
public class MetadataQueryRsp extends QueryResponse {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof MetadataQueryRsp)) return false;
        final MetadataQueryRsp other = (MetadataQueryRsp) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof MetadataQueryRsp;
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setData(final Map<String, List<MetricMetadata>> data) {
        this.data = data;
    }
    ...
    public java.lang.String toString() {
        return "MetadataQueryRsp(data=" + this.getData() + ")";
    }
}
