...
public class SeriesQueryRsp extends QueryResponse {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof SeriesQueryRsp)) return false;
        final SeriesQueryRsp other = (SeriesQueryRsp) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof SeriesQueryRsp;
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setData(final List<MetricInfo> data) {
        this.data = data;
    }
    ...
    public java.lang.String toString() {
        return "SeriesQueryRsp(data=" + this.getData() + ")";
    }
}
