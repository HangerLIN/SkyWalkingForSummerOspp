...
public class OAPServerBootstrap {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(OAPServerBootstrap.class);
    ...
    public static void start() {
        ...
        try {
            ...
            manager.find(CoreModule.NAME).provider().getService(ServerStatusService.class).bootedNow(configLoader.getResolvedConfigurations(), System.currentTimeMillis());
