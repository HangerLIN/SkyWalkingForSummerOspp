...
public class AIPipelineConfig extends ModuleConfig {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setUriRecognitionServerAddr(final String uriRecognitionServerAddr) {
        this.uriRecognitionServerAddr = uriRecognitionServerAddr;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setUriRecognitionServerPort(final int uriRecognitionServerPort) {
        this.uriRecognitionServerPort = uriRecognitionServerPort;
    }
}
