...
public class LogAnalyzer {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(LogAnalyzer.class);
    ...
    private void createAnalysisListeners(Layer layer) {
        factoryManager.getLogAnalysisListenerFactories().stream().map(factory -> factory.create(layer)).filter(Objects::nonNull).forEach(listeners::add);
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public LogAnalyzer(final ModuleManager moduleManager, final LogAnalyzerModuleConfig moduleConfig, final ILogAnalysisListenerManager factoryManager) {
