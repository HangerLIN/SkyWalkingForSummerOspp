...
public class RecordSinkListener implements LogSinkListener {
    ...
    @Override
    public LogSinkListener parse(final LogData.Builder logData, final Message extraLog) {
        try {
            ...
            if (StringUtil.isNotEmpty(logData.getServiceInstance())) {
                log.setServiceInstanceId(IDManager.ServiceInstanceID.buildId(serviceId, namingControl.formatInstanceName(logData.getServiceInstance())));
            }
            // endpoint
    ...
    @lombok.Generated
    public RecordSinkListener(final SourceReceiver sourceReceiver, final NamingControl namingControl, final List<String> searchableTagKeys) {
