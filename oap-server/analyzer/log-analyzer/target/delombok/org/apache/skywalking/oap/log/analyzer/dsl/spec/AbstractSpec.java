...
public abstract class AbstractSpec {
    ...
    public String tag(String key) {
        return BINDING.get().log().getTags().getDataList().stream().filter(data -> key.equals(data.getKey())).map(KeyStringValuePair::getValue).findFirst().orElse("");
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public AbstractSpec(final ModuleManager moduleManager, final LogAnalyzerModuleConfig moduleConfig) {
