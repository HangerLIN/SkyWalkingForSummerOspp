...
public class TraceSamplingPolicyWatcher extends ConfigChangeWatcher {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(TraceSamplingPolicyWatcher.class);
    ...
    private boolean shouldSampleService(SamplingPolicy samplingPolicy, int sample, int duration) {
        return 
        // global policy
        (samplingPolicy.getDuration() != null && isOverSlowThreshold(duration, samplingPolicy.getDuration())) || (samplingPolicy.getRate() != null && withinRateRange(sample, samplingPolicy.getRate())) || (samplingPolicy.getDuration() == null && isOverDefaultSlowThreshold(duration)) || (samplingPolicy.getRate() == null && withinDefaultRateRange(sample));
    }
