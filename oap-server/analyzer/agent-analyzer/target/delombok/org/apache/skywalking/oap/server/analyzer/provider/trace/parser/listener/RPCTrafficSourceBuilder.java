...
class RPCTrafficSourceBuilder extends EndpointSourceBuilder {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setSourceEndpointOwnerServiceLayer(final Layer sourceEndpointOwnerServiceLayer) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setSourceEndpointOwnerServiceName(final String sourceEndpointOwnerServiceName) {
