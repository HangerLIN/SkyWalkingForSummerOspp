...
public class UninstrumentedGatewaysConfig extends ConfigChangeWatcher {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(UninstrumentedGatewaysConfig.class);
    ...
    private void onGatewaysUpdated(final GatewayInfos gateways) {
        ...
        if (isNull(gateways)) {
            ...
            gatewayInstanceKeyedByAddress = StreamSupport.stream(gateways.spliterator(), false).flatMap(instance -> instance.getInstances().stream()).collect(Collectors.toMap(GatewayInstanceInfo::getAddress, Function.identity()));
        }
    }
    ...
    private GatewayInfos parseGatewaysFromFile(final String file) {
        try {
            ...
            return new Yaml(new ClassFilterConstructor(new Class[] {GatewayInfos.class, GatewayInfo.class, GatewayInstanceInfo.class})).loadAs(reader, GatewayInfos.class);
    ...
    private GatewayInfos parseGatewaysFromYml(final String ymlContent) {
        try {
            return new Yaml(new ClassFilterConstructor(new Class[] {GatewayInfos.class, GatewayInfo.class, GatewayInstanceInfo.class})).loadAs(ymlContent, GatewayInfos.class);
        } catch (Exception e) {
    ...
    public static class GatewayInfo {
        ...
        @java.lang.SuppressWarnings("all")
        @lombok.Generated
        public void setInstances(final List<GatewayInstanceInfo> instances) {
    ...
    public static class GatewayInfos implements Iterable<GatewayInfo> {
        ...
        @java.lang.SuppressWarnings("all")
        @lombok.Generated
        public void setGateways(final Collection<GatewayInfo> gateways) {
