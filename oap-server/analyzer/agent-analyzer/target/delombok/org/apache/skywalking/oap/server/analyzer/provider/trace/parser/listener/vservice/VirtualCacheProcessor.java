...
public class VirtualCacheProcessor implements VirtualServiceProcessor {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(VirtualCacheProcessor.class);
    ...
    public void prepareVSIfNecessary(SpanObject span, SegmentObject segmentObject) {
        ...
        if ((op == VirtualCacheOperation.Write && latency > config.getCacheWriteLatencyThresholdsAndWatcher().getThreshold(cacheType)) || (op == VirtualCacheOperation.Read && latency > config.getCacheReadLatencyThresholdsAndWatcher().getThreshold(cacheType))) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public VirtualCacheProcessor(final NamingControl namingControl, final AnalyzerModuleConfig config) {
