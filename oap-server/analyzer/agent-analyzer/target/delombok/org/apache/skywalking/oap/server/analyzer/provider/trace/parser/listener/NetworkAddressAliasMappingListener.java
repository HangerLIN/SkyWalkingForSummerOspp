...
public class NetworkAddressAliasMappingListener implements EntryAnalysisListener {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(NetworkAddressAliasMappingListener.class);
        ...
        if (!span.getSpanLayer().equals(SpanLayer.MQ)) {
            span.getRefsList().forEach(segmentReference -> {
                if (RefType.CrossProcess.equals(segmentReference.getRefType())) {
                    final String networkAddressUsedAtPeer = namingControl.formatServiceName(segmentReference.getNetworkAddressUsedAtPeer());
                    if (config.getUninstrumentedGatewaysConfig().isAddressConfiguredAsGateway(networkAddressUsedAtPeer)) {
                        /*
                    ...
                    final String instanceName = namingControl.formatInstanceName(segmentObject.getServiceInstance());
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public NetworkAddressAliasMappingListener(final SourceReceiver sourceReceiver, final AnalyzerModuleConfig config, final NamingControl namingControl) {
