...
public class VirtualServiceAnalysisListener implements ExitAnalysisListener, LocalAnalysisListener, EntryAnalysisListener {
    ...
    public static class Factory implements AnalysisListenerFactory {
        ...
        public AnalysisListener create(ModuleManager moduleManager, AnalyzerModuleConfig config) {
            return new VirtualServiceAnalysisListener(sourceReceiver, Arrays.asList(new VirtualCacheProcessor(namingControl, config), new VirtualDatabaseProcessor(namingControl, config), new VirtualMQProcessor(namingControl)));
        }
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public VirtualServiceAnalysisListener(final SourceReceiver sourceReceiver, final List<VirtualServiceProcessor> virtualServiceProcessors) {
