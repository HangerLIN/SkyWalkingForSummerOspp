...
public class SegmentAnalysisListener implements FirstAnalysisListener, EntryAnalysisListener, SegmentListener {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(SegmentAnalysisListener.class);
    ...
    public static class Factory implements AnalysisListenerFactory {
        ...
        public AnalysisListener create(ModuleManager moduleManager, AnalyzerModuleConfig config) {
            return new SegmentAnalysisListener(sourceReceiver, sampler, forceSampleErrorSegment, namingControl, searchTagKeys, segmentStatusAnalyzer);
        }
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public SegmentAnalysisListener(final SourceReceiver sourceReceiver, final TraceSegmentSampler sampler, final boolean forceSampleErrorSegment, final NamingControl namingControl, final SearchableTracesTagsWatcher searchableTagKeys, final SegmentStatusAnalyzer segmentStatusAnalyzer) {
