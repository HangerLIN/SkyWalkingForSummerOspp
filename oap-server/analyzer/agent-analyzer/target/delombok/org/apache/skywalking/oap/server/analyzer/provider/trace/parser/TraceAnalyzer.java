...
public class TraceAnalyzer {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(TraceAnalyzer.class);
    ...
    private void createSpanListeners() {
        listenerManager.getSpanListenerFactories().forEach(spanListenerFactory -> analysisListeners.add(spanListenerFactory.create(moduleManager, config)));
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public TraceAnalyzer(final ModuleManager moduleManager, final SegmentParserListenerManager listenerManager, final AnalyzerModuleConfig config) {
