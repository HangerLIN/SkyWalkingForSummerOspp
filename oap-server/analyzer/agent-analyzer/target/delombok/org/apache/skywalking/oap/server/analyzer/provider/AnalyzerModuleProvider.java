...
public class AnalyzerModuleProvider extends ModuleProvider {
    ...
    public void start() throws ModuleStartException {
        ...
        getManager().find(CoreModule.NAME).provider().getService(OALEngineLoaderService.class).load(CoreOALDefine.INSTANCE);
    ...
    public String[] requiredModules() {
        return new String[] {TelemetryModule.NAME, CoreModule.NAME, ConfigurationModule.NAME};
    }
