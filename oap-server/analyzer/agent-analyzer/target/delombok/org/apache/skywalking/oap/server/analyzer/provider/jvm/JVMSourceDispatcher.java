...
public class JVMSourceDispatcher {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(JVMSourceDispatcher.class);
    ...
    private void sendToCpuMetricProcess(String service, String serviceId, String serviceInstance, String serviceInstanceId, long timeBucket, CPU cpu) {
    ...
    private void sendToGCMetricProcess(String service, String serviceId, String serviceInstance, String serviceInstanceId, long timeBucket, List<GC> gcs) {
        gcs.forEach(gc -> {
    ...
    private void sendToMemoryMetricProcess(String service, String serviceId, String serviceInstance, String serviceInstanceId, long timeBucket, List<Memory> memories) {
    ...
    private void sendToMemoryPoolMetricProcess(String service, String serviceId, String serviceInstance, String serviceInstanceId, long timeBucket, List<MemoryPool> memoryPools) {
    ...
    private void sendToThreadMetricProcess(String service, String serviceId, String serviceInstance, String serviceInstanceId, long timeBucket, Thread thread) {
    ...
    private void sendToClassMetricProcess(String service, String serviceId, String serviceInstance, String serviceInstanceId, long timeBucket, Class clazz) {
