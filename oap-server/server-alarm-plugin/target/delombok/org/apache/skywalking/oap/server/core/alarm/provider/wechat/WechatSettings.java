...
public class WechatSettings extends AlarmHookSettings {
    ...
    public WechatSettings(final String name, final AlarmHooksType type, final boolean isDefault) {
    ...
    public java.lang.String toString() {
        return "WechatSettings(textTemplate=" + this.getTextTemplate() + ", webhooks=" + this.getWebhooks() + ")";
    }
}
