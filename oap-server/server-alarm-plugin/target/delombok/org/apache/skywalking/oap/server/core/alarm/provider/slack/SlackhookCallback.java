...
public class SlackhookCallback extends HttpAlarmCallback {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(SlackhookCallback.class);
        ...
        for (Map.Entry<String, List<AlarmMessage>> entry : groupedMessages.entrySet()) {
            ...
            for (final var url : setting.getWebhooks()) {
                ...
                for (AlarmMessage item : messages) {
                    jsonElements.add(GSON.fromJson(String.format(setting.getTextTemplate(), item.getAlarmMessage()), JsonObject.class));
                }
