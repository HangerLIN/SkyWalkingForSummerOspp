...
public class WebhookCallback extends HttpAlarmCallback {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(WebhookCallback.class);
    ...
    public void doAlarm(List<AlarmMessage> alarmMessages) throws Exception {
        ...
        for (Map.Entry<String, List<AlarmMessage>> entry : groupedMessages.entrySet()) {
            ...
            if (setting == null || CollectionUtils.isEmpty(setting.getUrls()) || CollectionUtils.isEmpty(messages)) {
                continue;
            }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public WebhookCallback(final AlarmRulesWatcher alarmRulesWatcher) {
