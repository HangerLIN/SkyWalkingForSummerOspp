...
public class SlackSettings extends AlarmHookSettings {
    ...
    public SlackSettings(final String name, final AlarmHooksType type, final boolean isDefault) {
    ...
    public java.lang.String toString() {
        return "SlackSettings(textTemplate=" + this.getTextTemplate() + ", webhooks=" + this.getWebhooks() + ")";
    }
}
