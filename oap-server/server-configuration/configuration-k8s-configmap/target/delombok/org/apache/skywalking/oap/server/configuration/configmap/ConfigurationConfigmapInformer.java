...
public class ConfigurationConfigmapInformer {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ConfigurationConfigmapInformer.class);
    ...
    public ConfigurationConfigmapInformer(ConfigmapConfigurationSettings settings) {
        ...
        final var informer = client.configMaps().inNamespace(settings.getNamespace()).withLabelSelector(settings.getLabelSelector()).inform();
