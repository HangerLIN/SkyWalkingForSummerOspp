...
public abstract class ListeningConfigWatcherRegister extends ConfigWatcherRegister {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ListeningConfigWatcherRegister.class);
    ...
    public synchronized void registerConfigChangeWatcher(ConfigChangeWatcher watcher) {
        startListening(new WatcherHolder(watcher), new ConfigChangeCallback() {
            ...
            @Override
            public synchronized void onGroupValuesChanged(final WatcherHolder holder, final GroupConfigTable.GroupConfigItems groupConfigItems) {
