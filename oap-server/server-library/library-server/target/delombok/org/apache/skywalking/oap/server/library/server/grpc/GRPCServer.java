...
public class GRPCServer implements Server {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(GRPCServer.class);
    ...
    public void initialize() {
        ...
        nettyServerBuilder = nettyServerBuilder.maxConcurrentCallsPerConnection(maxConcurrentCallsPerConnection).maxInboundMessageSize(maxMessageSize).executor(executor);
