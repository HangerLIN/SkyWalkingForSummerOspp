...
public abstract class AbstractSslContext extends SslContext {
    ...
    protected AbstractSslContext(final String privateKeyFile, final String certChainFile, final String trustedCAsFile) {
        ...
        monitor = new MultipleFilesChangeMonitor(10, readableContents -> updateContext(privateKeyFile, certChainFile, trustedCAsFile), certChainFile, privateKeyFile, trustedCAsFile);
    }

    protected AbstractSslContext(final String caFile) {
        updateContext(caFile);
        monitor = new MultipleFilesChangeMonitor(10, readableContents -> updateContext(caFile), caFile);
    }
    ...
    @lombok.Generated
    protected void setCtx(final SslContext ctx) {
        this.ctx = ctx;
    }
}
