...
public abstract class ModuleProvider implements ModuleServiceHolder {
    ...
    @lombok.Generated
    public void setManager(final ModuleManager manager) {
        this.manager = manager;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    void setModuleDefine(final ModuleDefine moduleDefine) {
        this.moduleDefine = moduleDefine;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    void setBootingParameters(final TerminalFriendlyTable bootingParameters) {
