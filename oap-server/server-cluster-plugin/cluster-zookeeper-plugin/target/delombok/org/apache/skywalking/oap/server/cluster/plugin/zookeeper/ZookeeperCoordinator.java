...
public class ZookeeperCoordinator extends ClusterCoordinator {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ZookeeperCoordinator.class);
    ...
    ZookeeperCoordinator(final ModuleDefineHolder manager, final ClusterModuleZookeeperConfig config, final ServiceDiscovery<RemoteInstance> serviceDiscovery) {
    ...
    public void registerRemote(RemoteInstance remoteInstance) throws ServiceRegisterException {
        try {
            ...
            ServiceInstance<RemoteInstance> thisInstance = ServiceInstance.<RemoteInstance>builder().name(REMOTE_NAME_PATH).id(UUID.randomUUID().toString()).address(remoteInstance.getAddress().getHost()).port(remoteInstance.getAddress().getPort()).payload(remoteInstance).build();
