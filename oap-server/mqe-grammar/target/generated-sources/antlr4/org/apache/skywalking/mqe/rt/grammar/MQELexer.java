...
public class MQELexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"BOOL", "GENERAL_LABEL_NAME", "DOT", "COMMA", "L_PAREN", "R_PAREN", "L_BRACKET", 
			"R_BRACKET", "L_BRACE", "R_BRACE", "EQ", "SUB", "ADD", "MUL", "DIV", 
			"MOD", "DEQ", "NEQ", "LTE", "LT", "GTE", "GT", "AVG", "COUNT", "LATEST", 
			"MAX", "MIN", "SUM", "ABS", "CEIL", "FLOOR", "ROUND", "INCREASE", "RATE", 
			"TOP_N", "VIEW_AS_SEQ", "RELABELS", "ASC", "DES", "AGGREGATE_LABELS", 
			"INTEGER", "DECIMAL", "NAME_STRING", "VALUE_STRING", "Digit", "NameLetter", 
			"WS"
		};
	}
	...
	public MQELexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "MQELexer.g4"; }
