...
public class JVMMetricsHandler extends AbstractKafkaHandler {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(JVMMetricsHandler.class);
    ...
    public JVMMetricsHandler(ModuleManager manager, KafkaFetcherConfig config) {
        ...
        this.namingLengthControl = manager.find(CoreModule.NAME).provider().getService(NamingControl.class);
    }
    ...
    public void handle(final ConsumerRecord<String, Bytes> record) {
        try {
            ...
            if (log.isDebugEnabled()) {
                log.debug("Fetched JVM metrics from service[{}] instance[{}] reported.", metrics.getService(), metrics.getServiceInstance());
            }
