...
public abstract class PercentileFunction extends Meter implements AcceptableValue<PercentileFunction.PercentileArgument>, MultiIntValuesHolder {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(PercentileFunction.class);
    ...
    public boolean combine(final Metrics metrics) {
        ...
        if (!dataset.keysEqual(percentile.getDataset())) {
            log.warn("Incompatible input [{}}] for current PercentileFunction[{}], entity {}", percentile, this, entityId);
            return true;
        }
    ...
    public static class PercentileArgument {
        ...
        @java.lang.SuppressWarnings("all")
        @lombok.Generated
        public PercentileArgument(final BucketedValues bucketedValues, final int[] ranks) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PercentileFunction)) return false;
