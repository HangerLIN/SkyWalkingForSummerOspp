...
public interface StorageBuilderFactory extends Service {
     ...
     */
    Class<? extends StorageBuilder> builderOf(Class<? extends StorageData> dataType, Class<? extends StorageBuilder> defaultBuilder);
    ...
    class BuilderTemplateDefinition {
        ...
        @java.lang.SuppressWarnings("all")
        @lombok.Generated
        public BuilderTemplateDefinition(final String superClass, final String templatePath) {
    ...
    class Default implements StorageBuilderFactory {
        ...
        public BuilderTemplateDefinition builderTemplate() {
            return new BuilderTemplateDefinition(StorageBuilder.class.getName(), "metrics-builder");
        }

        @Override
        public Class<? extends StorageBuilder> builderOf(final Class<? extends StorageData> dataType, final Class<? extends StorageBuilder> defaultBuilder) {
