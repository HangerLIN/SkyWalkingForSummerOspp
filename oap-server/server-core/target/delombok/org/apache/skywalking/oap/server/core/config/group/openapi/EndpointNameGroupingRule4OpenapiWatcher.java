...
public class EndpointNameGroupingRule4OpenapiWatcher extends GroupConfigChangeWatcher {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(EndpointNameGroupingRule4OpenapiWatcher.class);
    private final EndpointNameGrouping grouping;
    private final Map<String, String> openapiDefs;

    public EndpointNameGroupingRule4OpenapiWatcher(ModuleProvider provider, EndpointNameGrouping grouping) throws FileNotFoundException {
