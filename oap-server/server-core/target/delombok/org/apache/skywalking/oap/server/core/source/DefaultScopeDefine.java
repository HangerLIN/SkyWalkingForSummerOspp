...
public class DefaultScopeDefine {
    ...
    private static void addNewScope(ScopeDeclaration declaration, Class originalClass) {
        ...
        if (id < 0) {
            throw new UnexpectedException("ScopeDeclaration id=" + id + " at " + originalClass.getName() + " is negative. ");
        }
        ...
        if (virtualColumn != null) {
            scopeDefaultColumns.add(new ScopeDefaultColumn(virtualColumn.fieldName(), virtualColumn.columnName(), virtualColumn.type(), virtualColumn.isID(), virtualColumn.length(), false));
        }
            ...
            for (Field field : scopeClassField) {
                ...
                if (definedByField != null) {
                    if (!definedByField.requireDynamicActive() || ACTIVE_EXTRA_MODEL_COLUMNS) {
                        scopeDefaultColumns.add(new ScopeDefaultColumn(field.getName(), definedByField.columnName(), field.getType(), false, definedByField.length(), definedByField.groupByCondInTopN()));
                    }
                }
            }
        }
    ...
    @lombok.Generated
    public static void setACTIVE_EXTRA_MODEL_COLUMNS(final boolean ACTIVE_EXTRA_MODEL_COLUMNS) {
        DefaultScopeDefine.ACTIVE_EXTRA_MODEL_COLUMNS = ACTIVE_EXTRA_MODEL_COLUMNS;
    }
}
