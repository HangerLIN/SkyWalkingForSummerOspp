...
public class Span {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public List<SpanAttachedEvent> getAttachedEvents() {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setSegmentSpanId(final String segmentSpanId) {
        this.segmentSpanId = segmentSpanId;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setSegmentParentSpanId(final String segmentParentSpanId) {
