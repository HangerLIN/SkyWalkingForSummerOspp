...
public class UITemplateManagementService implements Service {
    ...
    private UITemplateManagementDAO getUITemplateManagementDAO() {
        if (uiTemplateManagementDAO == null) {
            this.uiTemplateManagementDAO = moduleManager.find(StorageModule.NAME).provider().getService(UITemplateManagementDAO.class);
        }
    ...
    public List<DashboardConfiguration> getAllTemplates(Boolean includingDisabled) throws IOException {
        final List<DashboardConfiguration> allTemplates = getUITemplateManagementDAO().getAllTemplates(includingDisabled);
        return allTemplates;
    }
    ...
    @lombok.Generated
    public UITemplateManagementService(final ModuleManager moduleManager) {
