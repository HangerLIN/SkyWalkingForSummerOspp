...
public class OALEngineLoaderService implements Service {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(OALEngineLoaderService.class);
    ...
    public void load(OALDefine define) throws ModuleStartException {
        ...
        try {
            ...
            engine.setStorageBuilderFactory(moduleManager.find(StorageModule.NAME).provider().getService(StorageBuilderFactory.class));
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public OALEngineLoaderService(final ModuleManager moduleManager) {
