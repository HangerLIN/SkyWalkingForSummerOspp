...
public abstract class ModelInstaller implements ModelCreator.CreatingListener {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ModelInstaller.class);
    ...
    protected final void overrideColumnName(String columnName, String newName) {
        ModelManipulator modelOverride = moduleManager.find(CoreModule.NAME).provider().getService(ModelManipulator.class);
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ModelInstaller(final Client client, final ModuleManager moduleManager) {
        this.client = client;
