...
public class StorageID {
    ...
    public static class Fragment {
        ...
        @lombok.Generated
        public Fragment(final String[] name, final Class<?> type, final boolean mutate, final Object value) {
            this.name = name;
            this.type = type;
            this.mutate = mutate;
            this.value = value;
        ...
        public boolean equals(final java.lang.Object o) {
            ...
            if (!(o instanceof StorageID.Fragment)) return false;
            final StorageID.Fragment other = (StorageID.Fragment) o;
            if (!other.canEqual((java.lang.Object) this)) return false;
            if (!java.util.Arrays.deepEquals(this.name, other.name)) return false;
        ...
        protected boolean canEqual(final java.lang.Object other) {
            return other instanceof StorageID.Fragment;
        }
        ...
        public int hashCode() {
            final int PRIME = 59;
            int result = 1;
            result = result * PRIME + java.util.Arrays.deepHashCode(this.name);
    ...
    public boolean equals(final java.lang.Object o) {
        if (o == this) return true;
        if (!(o instanceof StorageID)) return false;
        final StorageID other = (StorageID) o;
        if (!other.canEqual((java.lang.Object) this)) return false;
        final java.lang.Object this$fragments = this.fragments;
        final java.lang.Object other$fragments = other.fragments;
    ...
    public int hashCode() {
        final int PRIME = 59;
        int result = 1;
        final java.lang.Object $fragments = this.fragments;
