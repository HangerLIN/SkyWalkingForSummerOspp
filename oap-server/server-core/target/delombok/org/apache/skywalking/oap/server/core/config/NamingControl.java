...
public class NamingControl implements Service {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(NamingControl.class);
    ...
    public String formatServiceName(String serviceName) {
        if (serviceName != null && serviceName.length() > serviceNameMaxLength) {
            ...
            if (log.isDebugEnabled()) {
                log.debug("Service {} has been renamed to {} due to length limitation {}", serviceName, rename, serviceNameMaxLength);
            }
            return rename;
        } else {
            return serviceName;
    ...
    public String formatInstanceName(String instanceName) {
        if (instanceName != null && instanceName.length() > instanceNameMaxLength) {
            ...
            if (log.isDebugEnabled()) {
                log.debug("Service instance {} has been renamed to {} due to length limitation {}", instanceName, rename, serviceNameMaxLength);
            }
            return rename;
        } else {
            return instanceName;
    ...
    public String formatEndpointName(String serviceName, String endpointName) {
        ...
        if (endpointName.length() > endpointNameMaxLength) {
            ...
            if (log.isDebugEnabled()) {
                log.debug("Endpoint {} has been renamed to {} due to length limitation {}", endpointName, lengthControlledName, serviceNameMaxLength);
            }
        }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public NamingControl(final int serviceNameMaxLength, final int instanceNameMaxLength, final int endpointNameMaxLength, final EndpointNameGrouping endpointNameGrouping) {
