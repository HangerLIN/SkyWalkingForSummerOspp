...
public class UIMenuManagementService implements Service {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(UIMenuManagementService.class);
    ...
    public UIMenuManagementService(ModuleManager moduleManager, CoreModuleConfig moduleConfig) {
        ...
        this.menuItemCache = CacheBuilder.newBuilder().maximumSize(1).refreshAfterWrite(moduleConfig.getUiMenuRefreshInterval(), TimeUnit.SECONDS).build(new CacheLoader<>() {
            @Override
