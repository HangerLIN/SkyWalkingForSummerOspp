...
public enum FunctionCategory {
    METER("meter", MeterFunction.class), METRICS("metrics", MetricsFunction.class);
    ...
    @lombok.Generated
    private FunctionCategory(final String name, final Class<? extends Annotation> annotationClass) {
        this.name = name;
