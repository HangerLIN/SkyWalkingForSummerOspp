...
@Stream(name = ZipkinServiceRelationTraffic.INDEX_NAME, scopeId = DefaultScopeDefine.ZIPKIN_SERVICE_RELATION, builder = ZipkinServiceRelationTraffic.Builder.class, processor = MetricsStreamProcessor.class)
...
public class ZipkinServiceRelationTraffic extends Metrics {
    ...
    protected StorageID id0() {
        return new StorageID().append(SERVICE_NAME, serviceName).append(REMOTE_SERVICE_NAME, remoteServiceName);
    }
    ...
    public static class Builder implements StorageBuilder<ZipkinServiceRelationTraffic> {
        ...
        @Override
        public void entity2Storage(final ZipkinServiceRelationTraffic storageData, final Convert2Storage converter) {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof ZipkinServiceRelationTraffic)) return false;
        final ZipkinServiceRelationTraffic other = (ZipkinServiceRelationTraffic) o;
        ...
        final java.lang.Object this$remoteServiceName = this.getRemoteServiceName();
        final java.lang.Object other$remoteServiceName = other.getRemoteServiceName();
        if (this$remoteServiceName == null ? other$remoteServiceName != null : !this$remoteServiceName.equals(other$remoteServiceName)) return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        final java.lang.Object $remoteServiceName = this.getRemoteServiceName();
        result = result * PRIME + ($remoteServiceName == null ? 43 : $remoteServiceName.hashCode());
        return result;
    }
