...
public class ProfileTaskLogRecord extends Record {
    ...
    @Override
    public StorageID id() {
        return new StorageID().append(TASK_ID, getTaskId()).append(INSTANCE_ID, getInstanceId()).append(OPERATION_TYPE, getOperationType()).append(OPERATION_TIME, getOperationTime());
    }
