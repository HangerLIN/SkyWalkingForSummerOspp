...
public class ProfileTaskMutationService implements Service {
     ...
     */
    public ProfileTaskCreationResult createTask(final String serviceId, final String endpointName, final long monitorStartTime, final int monitorDuration, final int minDurationThreshold, final int dumpPeriod, final int maxSamplingCount) throws IOException {
    ...
    private String checkDataSuccess(final String serviceId, final String endpointName, final long monitorStartTime, final long monitorEndTime, final int monitorDuration, final int minDurationThreshold, final int dumpPeriod, final int maxSamplingCount) throws IOException {
        // basic check
        if (serviceId == null) {
        ...
        final List<ProfileTask> alreadyHaveTaskList = getProfileTaskDAO().getTaskList(serviceId, null, null, endTimeBucket, 1);
    ...
    @lombok.Generated
    public ProfileTaskMutationService(final ModuleManager moduleManager) {
