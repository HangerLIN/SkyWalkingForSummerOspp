...
public class ServiceRelationClientSideMetrics extends Metrics {
    ...
    public static class Builder implements StorageBuilder<ServiceRelationClientSideMetrics> {
        ...
        @Override
        public void entity2Storage(final ServiceRelationClientSideMetrics storageData, final Convert2Storage converter) {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof ServiceRelationClientSideMetrics)) return false;
        final ServiceRelationClientSideMetrics other = (ServiceRelationClientSideMetrics) o;
