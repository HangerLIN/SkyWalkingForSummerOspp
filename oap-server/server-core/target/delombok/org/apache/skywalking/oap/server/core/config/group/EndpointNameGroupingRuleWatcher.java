...
public class EndpointNameGroupingRuleWatcher extends ConfigChangeWatcher {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(EndpointNameGroupingRuleWatcher.class);
    ...
    public EndpointNameGroupingRuleWatcher(ModuleProvider provider, EndpointNameGrouping grouping) throws FileNotFoundException {
        ...
        grouping.setEndpointGroupingRule(new EndpointGroupingRuleReader(ResourceUtils.read("endpoint-name-grouping.yml")).read());
    }
