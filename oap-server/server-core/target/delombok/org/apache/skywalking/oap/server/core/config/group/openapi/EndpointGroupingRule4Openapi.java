...
public class EndpointGroupingRule4Openapi {
    /*serviceName*//*endpointName*//*endpointGroupName*/private final Map<String, Map<String, String>> directLookup = new HashMap<>();
    ...
    void sortRulesByService(String serviceName) {
        ...
        if (rules != null) {
            rules.entrySet().forEach(stringFormatGroup -> {
                stringFormatGroup.getValue().sortRules(new EndpointGroupingRule4Openapi.EndpointGroupingRulesComparator());
            });
        }
    }
