...
public class NetworkAddressAliasCache implements Service {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(NetworkAddressAliasCache.class);
    ...
    public NetworkAddressAliasCache(CoreModuleConfig moduleConfig) {
        ...
        networkAddressAliasCache = CacheBuilder.newBuilder().initialCapacity(initialCapacitySize).maximumSize(moduleConfig.getMaxSizeOfNetworkAddressAlias()).build();
    }
