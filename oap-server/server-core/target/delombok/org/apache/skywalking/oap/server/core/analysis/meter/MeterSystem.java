...
public class MeterSystem implements Service {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(MeterSystem.class);
    ...
    public MeterSystem(final ModuleManager manager) {
        ...
        for (ClassPath.ClassInfo classInfo : classes) {
            ...
            if (functionClass.isAnnotationPresent(MeterFunction.class)) {
                ...
                functionRegister.put(metricsFunction.functionName(), (Class<? extends AcceptableValue>) functionClass);
            }
        }
    }
    ...
    private static class MeterDefinition {
        ...
        @java.lang.SuppressWarnings("all")
        @lombok.Generated
        public MeterDefinition(final ScopeType scopeType, final AcceptableValue meterPrototype, final Class<?> dataType) {
