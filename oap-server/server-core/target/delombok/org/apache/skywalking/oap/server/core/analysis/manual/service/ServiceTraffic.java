...
@Stream(name = ServiceTraffic.INDEX_NAME, scopeId = DefaultScopeDefine.SERVICE, builder = ServiceTraffic.Builder.class, processor = MetricsStreamProcessor.class)
...
public class ServiceTraffic extends Metrics {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof ServiceTraffic)) return false;
        final ServiceTraffic other = (ServiceTraffic) o;
