...
@Stream(name = ZipkinServiceSpanTraffic.INDEX_NAME, scopeId = DefaultScopeDefine.ZIPKIN_SERVICE_SPAN, builder = ZipkinServiceSpanTraffic.Builder.class, processor = MetricsStreamProcessor.class)
...
public class ZipkinServiceSpanTraffic extends Metrics {
    ...
    protected StorageID id0() {
        return new StorageID().append(SERVICE_NAME, serviceName).append(SPAN_NAME, spanName);
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof ZipkinServiceSpanTraffic)) return false;
        final ZipkinServiceSpanTraffic other = (ZipkinServiceSpanTraffic) o;
        ...
        final java.lang.Object this$spanName = this.getSpanName();
        final java.lang.Object other$spanName = other.getSpanName();
        if (this$spanName == null ? other$spanName != null : !this$spanName.equals(other$spanName)) return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        final java.lang.Object $spanName = this.getSpanName();
        result = result * PRIME + ($spanName == null ? 43 : $spanName.hashCode());
        return result;
    }
