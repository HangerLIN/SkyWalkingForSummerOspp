...
@Stream(name = ProcessRelationServerSideMetrics.INDEX_NAME, scopeId = DefaultScopeDefine.PROCESS_RELATION, builder = ProcessRelationServerSideMetrics.Builder.class, processor = MetricsStreamProcessor.class)
...
public class ProcessRelationServerSideMetrics extends Metrics {
    ...
    public static class Builder implements StorageBuilder<ProcessRelationServerSideMetrics> {
        ...
        @Override
        public void entity2Storage(final ProcessRelationServerSideMetrics storageData, final Convert2Storage converter) {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof ProcessRelationServerSideMetrics)) return false;
        final ProcessRelationServerSideMetrics other = (ProcessRelationServerSideMetrics) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof ProcessRelationServerSideMetrics;
    }
