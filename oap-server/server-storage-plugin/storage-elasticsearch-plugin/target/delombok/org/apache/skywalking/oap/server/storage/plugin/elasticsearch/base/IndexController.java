...
public enum IndexController {
    ...
    public static class LogicIndicesRegister {
        ...
        /*physical index name*//*column name*/private static final Map<String, Map<String, ModelColumn>> PHYSICAL_INDICES_COLUMNS = new HashMap<>();
        /*logic index name*//*column name*//*alias*/private static final Map<String, Map<String, String>> LEGACY_COLUMNS_NAMES = new HashMap<>();
        /**
        ...
        public static void registerRelation(Model model, String physicalName) {
            ...
            Map<String, ModelColumn> columns = PHYSICAL_INDICES_COLUMNS.computeIfAbsent(physicalName, v -> new HashMap<>());
            if (!IndexController.INSTANCE.logicSharding || !model.isTimeSeries()) {
                ...
                model.getColumns().forEach(modelColumn -> {
                    ...
                    if (!Strings.isNullOrEmpty(legacyName)) {
                        Map<String, String> legacyNames = LEGACY_COLUMNS_NAMES.computeIfAbsent(model.getName(), v -> new HashMap<>());
