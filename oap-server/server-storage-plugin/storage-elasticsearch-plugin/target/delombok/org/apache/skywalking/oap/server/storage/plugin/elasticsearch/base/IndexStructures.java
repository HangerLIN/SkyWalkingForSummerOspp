...
public class IndexStructures {
    ...
    public Mappings getMapping(String tableName) {
        Map<String, Object> properties = mappingStructures.containsKey(tableName) ? mappingStructures.get(tableName).properties : new HashMap<>();
        Mappings.Source source = mappingStructures.containsKey(tableName) ? mappingStructures.get(tableName).source : new Mappings.Source();
        return Mappings.builder().type(ElasticSearchClient.TYPE).properties(properties).source(source).build();
    }
    ...
    public void putStructure(String tableName, Mappings mapping, Map<String, Object> settings) {
        if (CollectionUtils.isNotEmpty(settings) && Objects.nonNull(settings.get("index"))) {
            this.indexSettingStructures.putIfAbsent(tableName, new UpdatableIndexSettings((Map<String, Object>) settings.get("index")));
        }
    ...
    public Mappings diffMappings(String tableName, Mappings mappings) {
        ...
        Map<String, Object> diffProperties = mappingStructures.get(tableName).diffFields(new Fields(mappings));
    ...
    public boolean containsMapping(String tableName, Mappings mappings) {
        ...
        return mappingStructures.containsKey(tableName) && mappingStructures.get(tableName).containsAllFields(new Fields(mappings));
    }
    ...
    public boolean containsFieldNames(String tableName, Mappings mappings) {
        ...
        return mappingStructures.containsKey(tableName) && mappingStructures.get(tableName).containsAllFieldNames(new Fields(mappings));
    }
    ...
    public boolean compareIndexSetting(String tableName, Map<String, Object> settings) {
        if ((CollectionUtils.isEmpty(settings) || CollectionUtils.isEmpty((Map) settings.get("index"))) && Objects.isNull(indexSettingStructures.get(tableName))) {
            return true;
        }
        return indexSettingStructures.containsKey(tableName) && indexSettingStructures.get(tableName).equals(new UpdatableIndexSettings((Map<String, Object>) settings.get("index")));
    }
    ...
    public static class UpdatableIndexSettings {
        ...
        public boolean equals(final java.lang.Object o) {
            ...
            if (!(o instanceof IndexStructures.UpdatableIndexSettings)) return false;
            final IndexStructures.UpdatableIndexSettings other = (IndexStructures.UpdatableIndexSettings) o;
            if (!other.canEqual((java.lang.Object) this)) return false;
            final java.lang.Object this$replicas = this.replicas;
            final java.lang.Object other$replicas = other.replicas;
            if (this$replicas == null ? other$replicas != null : !this$replicas.equals(other$replicas)) return false;
            final java.lang.Object this$shards = this.shards;
            final java.lang.Object other$shards = other.shards;
            if (this$shards == null ? other$shards != null : !this$shards.equals(other$shards)) return false;
            return true;
        }
        ...
        protected boolean canEqual(final java.lang.Object other) {
            return other instanceof IndexStructures.UpdatableIndexSettings;
        }
        ...
        public int hashCode() {
            final int PRIME = 59;
            int result = 1;
            final java.lang.Object $replicas = this.replicas;
            result = result * PRIME + ($replicas == null ? 43 : $replicas.hashCode());
            final java.lang.Object $shards = this.shards;
