...
public class TimeSeriesUtils {
    ...
    public static String[] superDatasetIndexNames(String indexName, long startSecondTB, long endSecondTB) {
        ...
        if (timeRanges.isEmpty()) {
            ...
            return timeRanges.stream().map(item -> indexName + Const.LINE + compressDateTime(item, SUPER_DATASET_DAY_STEP)).distinct().toArray(String[]::new);
        }
    }
    ...
    @lombok.Generated
    public static void setDAY_STEP(final int DAY_STEP) {
        TimeSeriesUtils.DAY_STEP = DAY_STEP;
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public static void setSUPER_DATASET_DAY_STEP(final int SUPER_DATASET_DAY_STEP) {
