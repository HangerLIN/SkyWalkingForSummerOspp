...
public class UITemplateManagementEsDAO extends ManagementCRUDEsDAO implements UITemplateManagementDAO {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(UITemplateManagementEsDAO.class);
    ...
    public List<DashboardConfiguration> getAllTemplates(final Boolean includingDisabled) {
        ...
        if (!includingDisabled) {
            boolQuery.must(Query.term(UITemplate.DISABLED, BooleanUtils.booleanToValue(includingDisabled)));
        }
        final SearchBuilder search = 
        // It is impossible we have 10000+ templates.
        Search.builder().query(boolQuery).size(10000);
        final String index = IndexController.LogicIndicesRegister.getPhysicalTableName(UITemplate.INDEX_NAME);
