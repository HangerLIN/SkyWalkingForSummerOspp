...
public class JDBCUITemplateManagementDAO extends JDBCSQLExecutor implements UITemplateManagementDAO {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(JDBCUITemplateManagementDAO.class);
    ...
    public DashboardConfiguration getTemplate(final String id) {
        try {
            ...
            for (String table : tables) {
                ...
                sql.append("select * from ").append(table).append(" where ").append(JDBCTableInstaller.TABLE_COLUMN).append(" = ?").append(" and id=? LIMIT 1 ");
    ...
    public TemplateChangeStatus addTemplate(final DashboardSetting setting) throws IOException {
        ...
        final SQLExecutor insertExecutor = getInsertExecutor(model, uiTemplate, 0, new UITemplate.Builder(), new HashMapConverter.ToStorage(), null);
    ...
    private TemplateChangeStatus executeUpdate(final UITemplate uiTemplate) throws IOException {
        final var model = TableMetaInfo.get(UITemplate.INDEX_NAME);
        final var updateExecutor = getUpdateExecutor(model, uiTemplate, 0, new UITemplate.Builder(), null);
        try (Connection connection = h2Client.getConnection()) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public JDBCUITemplateManagementDAO(final JDBCClient h2Client, final TableHelper tableHelper) {
