...
public class JDBCRecordsQueryDAO implements IRecordsQueryDAO {
    ...
    @Override
    public List<Record> readRecords(final RecordCondition condition, final String valueColumnName, final Duration duration) {
        try {
    ...
    @lombok.Generated
    public JDBCRecordsQueryDAO(final JDBCClient jdbcClient, final TableHelper tableHelper) {
