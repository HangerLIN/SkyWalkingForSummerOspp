...
public class BatchSQLExecutor implements InsertRequest, UpdateRequest {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(BatchSQLExecutor.class);
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public BatchSQLExecutor(final JDBCClient jdbcClient, final List<PrepareRequest> prepareRequests) {
