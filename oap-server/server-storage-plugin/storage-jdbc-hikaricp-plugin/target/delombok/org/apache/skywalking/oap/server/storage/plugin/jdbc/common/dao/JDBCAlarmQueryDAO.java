...
public class JDBCAlarmQueryDAO implements IAlarmQueryDAO {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(JDBCAlarmQueryDAO.class);
    ...
    @Override
    public Alarms getAlarm(Integer scopeId, String keyword, int limit, int from, Duration duration, final List<Tag> tags) {
        try {
            ...
            final var tables = tableHelper.getTablesForRead(AlarmRecord.INDEX_NAME, duration.getStartTimeBucket(), duration.getEndTimeBucket());
            ...
            return new Alarms(alarmMsgs.stream().sorted(comparing(AlarmMessage::getStartTime).reversed()).skip(from).limit(limit).collect(toList()));
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public JDBCAlarmQueryDAO(final JDBCClient jdbcClient, final ModuleManager manager, final TableHelper tableHelper) {
