...
public class JDBCEBPFProfilingScheduleDAO implements IEBPFProfilingScheduleDAO {
    ...
    public List<EBPFProfilingSchedule> querySchedules(String taskId) {
        try {
            ...
            for (final var table : tables) {
                ...
                schedules.addAll(jdbcClient.executeQuery(sqlAndParameters.sql(), this::buildSchedules, sqlAndParameters.parameters()));
            }
            return schedules;
    ...
    protected SQLAndParameters buildSQL(final String taskId, final String table) {
    ...
    @lombok.Generated
    public JDBCEBPFProfilingScheduleDAO(final JDBCClient jdbcClient, final TableHelper tableHelper) {
