...
public class JDBCProfileTaskLogQueryDAO implements IProfileTaskLogQueryDAO {
    ...
    public List<ProfileTaskLog> getTaskLogList() {
        try {
            ...
            for (final var table : tables) {
                ...
                results.addAll(jdbcClient.executeQuery(sqlAndParameters.sql(), resultSet -> {
    ...
    private ProfileTaskLog parseLog(ResultSet data) throws SQLException {
        return ProfileTaskLog.builder().id(data.getString("id")).taskId(data.getString(ProfileTaskLogRecord.TASK_ID)).instanceId(data.getString(ProfileTaskLogRecord.INSTANCE_ID)).operationType(ProfileTaskLogOperationType.parse(data.getInt(ProfileTaskLogRecord.OPERATION_TYPE))).operationTime(data.getLong(ProfileTaskLogRecord.OPERATION_TIME)).build();
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public JDBCProfileTaskLogQueryDAO(final JDBCClient jdbcClient, final TableHelper tableHelper) {
