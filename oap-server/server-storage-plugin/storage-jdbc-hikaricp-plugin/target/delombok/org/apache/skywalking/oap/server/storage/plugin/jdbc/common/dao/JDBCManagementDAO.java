...
public class JDBCManagementDAO extends JDBCSQLExecutor implements IManagementDAO {
    ...
    public void insert(Model model, ManagementData storageData) throws IOException {
        try (Connection connection = jdbcClient.getConnection()) {
            ...
            SQLExecutor insertExecutor = getInsertExecutor(model, storageData, 0, storageBuilder, new HashMapConverter.ToStorage(), null);
    ...
    @lombok.Generated
    public JDBCManagementDAO(final JDBCClient jdbcClient, final StorageBuilder<ManagementData> storageBuilder) {
