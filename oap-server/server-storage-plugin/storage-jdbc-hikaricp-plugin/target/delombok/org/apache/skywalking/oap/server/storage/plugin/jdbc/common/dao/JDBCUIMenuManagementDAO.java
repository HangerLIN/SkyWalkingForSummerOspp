...
public class JDBCUIMenuManagementDAO extends JDBCSQLExecutor implements UIMenuManagementDAO {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(JDBCUIMenuManagementDAO.class);
    ...
    public void saveMenu(UIMenu menu) throws IOException {
        try {
            ...
            final SQLExecutor insertExecutor = getInsertExecutor(model, menu, 0, new UIMenu.Builder(), new HashMapConverter.ToStorage(), null);
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public JDBCUIMenuManagementDAO(final JDBCClient h2Client, final TableHelper tableHelper) {
