...
public class BanyanDBEBPFProfilingScheduleQueryDAO extends AbstractBanyanDBDAO implements IEBPFProfilingScheduleDAO {
     ...
     @lombok.Generated
     private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(BanyanDBEBPFProfilingScheduleQueryDAO.class);
     private static final Set<String> TAGS = ImmutableSet.of(EBPFProfilingScheduleRecord.START_TIME, EBPFProfilingScheduleRecord.EBPF_PROFILING_SCHEDULE_ID, EBPFProfilingScheduleRecord.TASK_ID, EBPFProfilingScheduleRecord.PROCESS_ID, EBPFProfilingScheduleRecord.END_TIME);
     ...
     public List<EBPFProfilingSchedule> querySchedules(String taskId) throws IOException {
          MeasureQueryResponse resp = query(EBPFProfilingScheduleRecord.INDEX_NAME, TAGS, Collections.emptySet(), new QueryBuilder<MeasureQuery>() {
               @Override
