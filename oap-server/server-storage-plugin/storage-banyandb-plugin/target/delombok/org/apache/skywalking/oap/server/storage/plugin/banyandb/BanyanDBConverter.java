...
public class BanyanDBConverter {
    ...
    public static class StreamToStorage implements Convert2Storage<StreamWrite> {
        ...
        @lombok.Generated
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(StreamToStorage.class);
        private final MetadataRegistry.Schema schema;
        ...
        @java.lang.SuppressWarnings("all")
        @lombok.Generated
        public StreamToStorage(final MetadataRegistry.Schema schema, final StreamWrite streamWrite) {
            this.schema = schema;
    ...
    public static class MeasureToStorage implements Convert2Storage<MeasureWrite> {
        @java.lang.SuppressWarnings("all")
        @lombok.Generated
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(MeasureToStorage.class);
        private final MetadataRegistry.Schema schema;
        ...
        @java.lang.SuppressWarnings("all")
        @lombok.Generated
        public MeasureToStorage(final MetadataRegistry.Schema schema, final MeasureWrite measureWrite) {
            this.schema = schema;
