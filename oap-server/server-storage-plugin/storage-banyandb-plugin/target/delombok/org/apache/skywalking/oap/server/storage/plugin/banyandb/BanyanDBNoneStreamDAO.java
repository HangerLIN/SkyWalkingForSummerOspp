...
public class BanyanDBNoneStreamDAO extends AbstractDAO<BanyanDBStorageClient> implements INoneStreamDAO {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(BanyanDBNoneStreamDAO.class);
    ...
    public void insert(Model model, NoneStream noneStream) throws IOException {
        ...
        StreamWrite streamWrite = getClient().client.createStreamWrite(schema.getMetadata().getGroup(),  // group name
