...
public class BanyanDBManagementDAO implements IManagementDAO {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(BanyanDBManagementDAO.class);
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public BanyanDBManagementDAO(final BanyanDBStorageClient client, final StorageBuilder<ManagementData> storageBuilder) {
        this.client = client;
