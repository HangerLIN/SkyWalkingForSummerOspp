...
public class BanyanDBUIMenuManagementDAO extends AbstractBanyanDBDAO implements UIMenuManagementDAO {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(BanyanDBUIMenuManagementDAO.class);
    ...
    public void saveMenu(UIMenu menu) throws IOException {
        this.getClient().define(Property.create(GROUP, UIMenu.INDEX_NAME, menu.id().build()).addTag(TagAndValue.newStringTag(UIMenu.CONFIGURATION, menu.getConfigurationJson())).addTag(TagAndValue.newLongTag(UIMenu.UPDATE_TIME, menu.getUpdateTime())).build());
    }
