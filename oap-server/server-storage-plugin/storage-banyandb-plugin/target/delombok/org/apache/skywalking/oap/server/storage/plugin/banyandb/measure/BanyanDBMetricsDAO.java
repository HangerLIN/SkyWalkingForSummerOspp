...
public class BanyanDBMetricsDAO extends AbstractBanyanDBDAO implements IMetricsDAO {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(BanyanDBMetricsDAO.class);
    ...
    public List<Metrics> multiGet(Model model, List<Metrics> metrics) throws IOException {
        ...
        for (Metrics m : metrics) {
            ...
            if (model.getBanyanDBModelExtension().isStoreIDTag()) {
                ...
                fragments = Arrays.asList(new StorageID.Fragment(new String[] {BanyanDBConverter.ID}, String.class, true, val));
            }
