...
public class TCPLogsPersistence implements TCPAccessLogAnalyzer {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(TCPLogsPersistence.class);
    ...
    @Override
    public Result analysis(final Result result, final StreamAccessLogsMessage.Identifier identifier, final TCPAccessLogEntry entry, final Role role) {
        try {
    ...
    public LogData convertToLogData(final TCPAccessLogEntry logEntry, final Result result) {
        ...
        final TCPServiceMeshMetric.Builder metrics = new TCPLogEntry2MetricsAdapter(logEntry, null, null).adaptCommonPart();
