...
public abstract class AbstractTCPAccessLogAnalyzer implements TCPAccessLogAnalyzer {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(AbstractTCPAccessLogAnalyzer.class);
     ...
     */
    protected TCPLogEntry2MetricsAdapter newAdapter(final TCPAccessLogEntry entry, final ServiceMetaInfo sourceService, final ServiceMetaInfo targetService) {
