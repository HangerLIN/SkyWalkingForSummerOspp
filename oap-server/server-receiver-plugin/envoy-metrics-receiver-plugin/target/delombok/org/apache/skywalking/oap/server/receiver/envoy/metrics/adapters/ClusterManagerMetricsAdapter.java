...
public class ClusterManagerMetricsAdapter {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ClusterManagerMetricsAdapter.class);
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ClusterManagerMetricsAdapter(final EnvoyMetricReceiverConfig config) {
        this.config = config;
    }
}
