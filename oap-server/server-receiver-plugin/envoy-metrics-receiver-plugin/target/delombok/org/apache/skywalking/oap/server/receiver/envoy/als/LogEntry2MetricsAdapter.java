...
public class LogEntry2MetricsAdapter {
    ...
    public HTTPServiceMeshMetric.Builder adaptToDownstreamMetrics() {
        ...
        return adaptCommonPart().setStartTime(startTime).setEndTime(startTime + duration).setLatency((int) Math.max(1L, duration)).setDetectPoint(DetectPoint.server);
    }
    ...
    public HTTPServiceMeshMetric.Builder adaptCommonPart() {
        ...
        final long internalResponseLatencyNanos = properties.getTimeToFirstDownstreamTxByte().getNanos() - properties.getTimeToFirstUpstreamRxByte().getNanos();
    ...
    @lombok.Generated
    public LogEntry2MetricsAdapter(final HTTPAccessLogEntry entry, final ServiceMetaInfo sourceService, final ServiceMetaInfo targetService) {
        this.entry = entry;
