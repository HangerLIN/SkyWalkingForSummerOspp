...
public abstract class AbstractALSAnalyzer implements ALSHTTPAnalysis {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(AbstractALSAnalyzer.class);
     ...
     */
    protected LogEntry2MetricsAdapter newAdapter(final HTTPAccessLogEntry entry, final ServiceMetaInfo sourceService, final ServiceMetaInfo targetService) {
