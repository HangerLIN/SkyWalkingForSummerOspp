...
public class LogsPersistence implements ALSHTTPAnalysis {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(LogsPersistence.class);
    ...
    public LogData convertToLogData(final HTTPAccessLogEntry logEntry, final Result result) {
        ...
        final HTTPServiceMeshMetric.Builder metrics = new LogEntry2MetricsAdapter(logEntry, null, null).adaptCommonPart();
