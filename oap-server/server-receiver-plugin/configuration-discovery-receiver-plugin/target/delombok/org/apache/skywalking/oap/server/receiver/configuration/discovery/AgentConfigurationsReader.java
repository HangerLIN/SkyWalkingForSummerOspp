...
public class AgentConfigurationsReader {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(AgentConfigurationsReader.class);
            ...
            if (Objects.nonNull(yamlData)) {
                ...
                if (configurationsData != null) {
                    configurationsData.forEach((k, v) -> {
                        ...
                        AgentConfigurations agentConfigurations = new AgentConfigurations(k.toString(), config, Hashing.sha512().hashString(serviceConfigStr.toString(), StandardCharsets.UTF_8).toString());
