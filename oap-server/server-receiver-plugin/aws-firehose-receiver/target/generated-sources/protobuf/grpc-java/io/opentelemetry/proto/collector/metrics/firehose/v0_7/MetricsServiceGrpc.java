package io.opentelemetry.proto.collector.metrics.firehose.v0_7;
...
public final class MetricsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceRequest,
      io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceResponse> getExportMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Export",
      requestType = io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceRequest.class,
      responseType = io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceRequest,
      io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceResponse> getExportMethod() {
    io.grpc.MethodDescriptor<io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceRequest, io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceResponse> getExportMethod;
      ...
      synchronized (MetricsServiceGrpc.class) {
        if ((getExportMethod = MetricsServiceGrpc.getExportMethod) == null) {
          MetricsServiceGrpc.getExportMethod = getExportMethod =
              io.grpc.MethodDescriptor.<io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceRequest, io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Export"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceResponse.getDefaultInstance()))
  ...
  public static abstract class MetricsServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void export(io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceRequest request,
        io.grpc.stub.StreamObserver<io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceRequest,
                io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceResponse>(
  ...
  public static final class MetricsServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MetricsServiceBlockingStub> {
     ...
     * </pre>
     */
    public io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceResponse export(io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceRequest request) {
  ...
  public static final class MetricsServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MetricsServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceResponse> export(
        io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_EXPORT:
          serviceImpl.export((io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceRequest) request,
              (io.grpc.stub.StreamObserver<io.opentelemetry.proto.collector.metrics.firehose.v0_7.ExportMetricsServiceResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class MetricsServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.opentelemetry.proto.collector.metrics.firehose.v0_7.MetricsServiceProto.getDescriptor();
    }
