...
public interface DoubleExemplarOrBuilder extends
    // @@protoc_insertion_point(interface_extends:opentelemetry.proto.metrics.v1.DoubleExemplar)
   ...
   * <code>repeated .opentelemetry.proto.common.v1.StringKeyValue filtered_labels = 1;</code>
   */
  io.opentelemetry.proto.common.firehose.v0_7.StringKeyValue getFilteredLabels(int index);
  /**
   * <pre>
   * The set of labels that were filtered out by the aggregator, but recorded
   * alongside the original measurement. Only labels that were filtered out
   ...
   * <code>repeated .opentelemetry.proto.common.v1.StringKeyValue filtered_labels = 1;</code>
   */
  io.opentelemetry.proto.common.firehose.v0_7.StringKeyValueOrBuilder getFilteredLabelsOrBuilder(
      int index);
