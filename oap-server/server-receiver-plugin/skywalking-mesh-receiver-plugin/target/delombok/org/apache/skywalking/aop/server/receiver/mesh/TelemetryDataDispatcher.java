// Generated by delombok at Thu Apr 18 20:40:06 CST 2024
/*
...
public class TelemetryDataDispatcher {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(TelemetryDataDispatcher.class);
    ...
    public static void init(ModuleManager moduleManager) {
        ...
        NAME_LENGTH_CONTROL = moduleManager.find(CoreModule.NAME).provider().getService(NamingControl.class);
        MESH_ANALYSIS_METRICS = metricsCreator.createHistogramMetric("mesh_analysis_latency", "The process latency of service mesh telemetry", MetricsTag.EMPTY_KEY, MetricsTag.EMPTY_VALUE);
    ...
    private static void toServiceInstanceTraffic(HTTPServiceMeshMetric.Builder metrics, long minuteTimeBucket) {
        ...
        if (metrics.getDestInstancePropertiesList() != null) {
            ...
            metrics.getDestInstancePropertiesList().stream().forEach(it -> properties.addProperty(it.getKey(), it.getValue()));
