...
public class ZipkinSpanHTTPHandler {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ZipkinSpanHTTPHandler.class);
    ...
    public ZipkinSpanHTTPHandler(SpanForward forward, ModuleManager manager) {
        ...
        histogram = metricsCreator.createHistogramMetric("trace_in_latency", "The process latency of trace data", new MetricsTag.Keys("protocol"), new MetricsTag.Values("zipkin-http"));
        errorCounter = metricsCreator.createCounter("trace_analysis_error_count", "The error number of trace analysis", new MetricsTag.Keys("protocol"), new MetricsTag.Values("zipkin-http"));
    }
    ...
    HttpResponse doCollectSpans(final SpanBytesDecoder decoder, final HttpRequest req) {
        ...
        final HttpResponse response = HttpResponse.from(req.aggregate().thenApply(request -> {
            try (HttpData httpData = request.content()) {
