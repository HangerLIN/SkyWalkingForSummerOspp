...
public class ErrorLogAnalyzer {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ErrorLogAnalyzer.class);
    ...
    private void createAnalysisListeners() {
        listenerManager.getErrorLogAnalysisListeners().forEach(factory -> analysisListeners.add(factory.create(moduleManager, moduleConfig)));
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ErrorLogAnalyzer(final ModuleManager moduleManager, final ErrorLogParserListenerManager listenerManager, final BrowserServiceModuleConfig moduleConfig) {
