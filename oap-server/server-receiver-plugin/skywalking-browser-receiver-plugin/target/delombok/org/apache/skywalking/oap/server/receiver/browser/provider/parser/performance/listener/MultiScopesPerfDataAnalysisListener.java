...
public class MultiScopesPerfDataAnalysisListener implements PerfDataAnalysisListener {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(MultiScopesPerfDataAnalysisListener.class);
    private final SourceReceiver sourceReceiver;
    private final SourceBuilder sourceBuilder;

    public MultiScopesPerfDataAnalysisListener(final SourceReceiver sourceReceiver, final NamingControl namingControl) {
    ...
    public static class Factory implements PerfDataListenerFactory {
        ...
        @Override
        public PerfDataAnalysisListener create(final ModuleManager moduleManager, final BrowserServiceModuleConfig moduleConfig) {
