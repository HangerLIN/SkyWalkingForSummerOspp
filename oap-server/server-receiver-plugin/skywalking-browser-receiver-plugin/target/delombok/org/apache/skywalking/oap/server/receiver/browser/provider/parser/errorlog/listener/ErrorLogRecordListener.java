...
public class ErrorLogRecordListener implements ErrorLogAnalysisListener {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ErrorLogRecordListener.class);
    ...
    public void parse(final BrowserErrorLogDecorator decorator) {
        ...
        // service version
        errorLog.setServiceVersionId(IDManager.ServiceInstanceID.buildId(serviceId, namingControl.formatInstanceName(decorator.getServiceVersion())));
        // page
    ...
    public static class Factory implements ErrorLogListenerFactory {
        ...
        @Override
        public ErrorLogAnalysisListener create(final ModuleManager moduleManager, final BrowserServiceModuleConfig moduleConfig) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ErrorLogRecordListener(final NamingControl namingControl, final SourceReceiver sourceReceiver, final ErrorLogRecordSampler sampler) {
