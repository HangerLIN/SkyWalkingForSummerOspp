...
public class OpenTelemetryTraceHandler extends TraceServiceGrpc.TraceServiceImplBase implements Handler {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(OpenTelemetryTraceHandler.class);
    ...
    private void convertLink(Map<String, String> tags, List<io.opentelemetry.proto.trace.v1.Span.Link> links) {
        for (int i = 0; i < links.size(); i++) {
            ...
            tags.put("otlp.link." + i, idToHexString(link.getTraceId()) + "|" + idToHexString(link.getSpanId()) + "|" + link.getTraceState() + "|" + convertToString(link.getAttributesList()) + "|" + link.getDroppedAttributesCount());
        }
    }
    ...
    private Map<String, String> convertAttributeToMap(List<KeyValue> attrs) {
        return attrs.stream().collect(Collectors.toMap(KeyValue::getKey, attributeKeyValue -> convertToString(attributeKeyValue.getValue()), (v1, v2) -> v1));
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public OpenTelemetryTraceHandler(final ModuleManager manager) {
