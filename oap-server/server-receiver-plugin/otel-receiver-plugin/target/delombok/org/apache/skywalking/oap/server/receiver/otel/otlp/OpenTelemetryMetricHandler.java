...
public class OpenTelemetryMetricHandler extends MetricsServiceGrpc.MetricsServiceImplBase implements Handler {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(OpenTelemetryMetricHandler.class);
    ...
    @Override
    public void export(final ExportMetricsServiceRequest requests, final StreamObserver<ExportMetricsServiceResponse> responseObserver) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public OpenTelemetryMetricHandler(final ModuleManager manager, final OpenTelemetryMetricRequestProcessor metricRequestProcessor) {
