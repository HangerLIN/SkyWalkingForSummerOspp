...
public class TelegrafServiceHandler {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(TelegrafServiceHandler.class);
    ...
    public TelegrafServiceHandler(ModuleManager moduleManager, MeterSystem meterSystem, List<Rule> rules) {
        ...
        histogram = metricsCreator.createHistogramMetric("telegraf_in_latency", "The process latency of telegraf data", new MetricsTag.Keys("protocol"), new MetricsTag.Values("http"));
        errorCounter = metricsCreator.createCounter("telegraf_error_count", "The error number of telegraf analysis", new MetricsTag.Keys("protocol"), new MetricsTag.Values("http"));
    }
    ...
    public List<ImmutableMap<String, SampleFamily>> convertSampleFamily(TelegrafData telegrafData) {
        ...
        for (List<Sample> s : sampleFamilyByTime.values()) {
            ...
            sampleFamilyByName.forEach((k, v) -> builder.put(k, SampleFamilyBuilder.newBuilder(v.toArray(new Sample[0])).build()));
