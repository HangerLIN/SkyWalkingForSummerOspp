...
public class ZabbixProtocolDecoder extends ByteToMessageDecoder {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ZabbixProtocolDecoder.class);
    ...
    public String decodeToPayload(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf) throws InterruptedException, ZabbixErrorProtocolException {
        ...
        // Check payload
        int dataLength = headerBuf.getByte(5) & 255 | (headerBuf.getByte(6) & 255) << 8 | (headerBuf.getByte(7) & 255) << 16 | (headerBuf.getByte(8) & 255) << 24;
